...
DOC_PATH = "../data/shortened.txt"  # Path to your document
...
# if the database does not exist, generate it
if not os.path.exists(CHROMA_PATH):
    gen_database()

# load the database
db_chroma = Chroma(persist_directory=CHROMA_PATH)


def query_database(query):

    query = "are there restrictions on the following part? : " + query
